...
## Kali Linux攻擊
#### 使用掃描器之王 nmap
#### Exploitation ==> 使用攻擊神器 metasploit framework
#### Post-Exploitation ==>metasploit 之 meterpreter
- 攻擊成功之後
  - 塞木馬
  - 塞後門程式
  - 在C:建立目錄 A888168
...
- /use/share/metasploit-framework/modules ==> 說明這七大模組
- 檢視攻擊程式碼
